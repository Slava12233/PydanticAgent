...
PRODUCT_TYPES = {
    ...
    "virtual": {
        "name": "מוצר וירטואלי",
        "description": "מוצר דיגיטלי ללא משלוח",
        "features": ["הורדה דיגיטלית", "ללא משלוח", "גישה מיידית"]
    },
    "downloadable": {
        "name": "מוצר להורדה",
        "description": "מוצר דיגיטלי עם קובץ להורדה",
        "features": ["קובץ להורדה", "מגבלת הורדות", "תוקף הורדה"]
    }
}
